...
return array(
	...
	'a_post_body_email'      => "^done_by has answered your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'c_post_body_email'      => "^done_by has commented on a post <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'q_reshow_body_email'    => "^done_by has reshown your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'a_reshow_body_email'    => "^done_by has reshown your answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'c_reshow_body_email'    => "^done_by has reshown your comment <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'a_select_body_email'    => "^done_by has selected your answer as best answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'q_vote_up_body_email'   => "^done_by has voted up your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'a_vote_up_body_email'   => "^done_by has voted up your answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'q_vote_down_body_email' => "^done_by has voted down your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'a_vote_down_body_email' => "^done_by has voted down your answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	
	'q_vote_nil_body_email' => "^done_by has removed his vote from your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> for more info ",
	'a_vote_nil_body_email' => "^done_by has removed his vote from your answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> for more info ",
	'q_approve_body_email'  => "^done_by has approved  your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'a_approve_body_email'  => "^done_by has approved  your answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'c_approve_body_email'  => "^done_by has approved  your comment <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'q_reject_body_email'   => "^done_by has rejected  your question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'a_reject_body_email'   => "^done_by has rejected  your answer <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	'c_reject_body_email'   => "^done_by has rejected  your comment <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
	...
	'q_post_body_email'     => "^done_by has posted a new question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",

	'u_favorite_body_email'  => "^done_by is now following you ",
	'u_message_body_email'   => "^done_by has sent a private message - ^q_content <a href='^url'>Click  here </a> to reply ",
	'u_wall_post_body_email' => "^done_by has posted on your wall ^q_content <a href='^url'>Click  here </a> to view ",
	...
	'related_body_email'     => "^done_by has posted a related question question <a href='^url'> ^q_title </a> ^q_content <a href='^url'>Click  here </a> to see the question",
