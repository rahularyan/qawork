...
if(function_exists('curl_version')){
	require_once CS_CONTROL_DIR.'/inc/TwitterAPI/TwitterAPIExchange.php';
...
class Qw_Tweet_Box_Addon{
	...
	public function language($lang_arr){
		$lang_arr['qw_tweet_box']   = CS_CONTROL_DIR .'/addons/tweet-box/language-*.php';
		return $lang_arr;
	}

	public function css($css_src){
		$css_src['qw_tweet_box']    = CS_CONTROL_URL . '/addons/tweet-box/styles.css';
		return  $css_src;
	}
