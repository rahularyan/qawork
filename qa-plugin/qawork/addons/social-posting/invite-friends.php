...
class qw_social_invite_friends_page {
      ...
      function process_request($request) {
            ...
            $qa_content['site_title'] = qa_lang_html('qw_social_posting/invite_frnds');
            $qa_content['title'] = qa_lang_html('qw_social_posting/invite_frnds');
            ...
            if (!$disp_conf) {
                  ...
                  $qa_content['form_facebook_invite'] = array(
                      'title' => qa_lang_html('qw_social_posting/invite_frnds'),
                      ...
                      'buttons' => array(
                          ...
                          'facebook_status_update' => array(
                              'tags' => 'name="facebook_sts_updt" onClick="'.qw_generate_facebook_wall_post_script(qa_opt("facebook_app_id"), array('name' => $name, 'picture' => "http://amiyasahu.com/assets/img/amiya.jpg" , 'link' => "http://amiyasahu.com" , 'caption'=>"Amiya Sahu" , 'description' => "Web Application Developer and Designer (Updated from my application )")).'"',
                              'label' => qa_lang_html('qw_social_posting/update_facebook_status'),
                          ),
                          
                          'facebook_link_share' => array(
                              'tags' => 'name="facebook_link_share" onClick="'.qw_generate_facebook_link_share_script(qa_opt("facebook_app_id"), array('to' => "sachi059", 'link' => "http://stackoverflow.com/questions/10415884/fb-init-has-already-been-called")).'"',
                              'label' => "Facebook link share ",
                          ),
                          
                          'facebook_login' => array(
                              'tags' => 'name="facebook_login" onClick="'.qw_generate_facebook_login_script(qa_opt("facebook_app_id")).'"',
