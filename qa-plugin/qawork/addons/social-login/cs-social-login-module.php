...
class qw_open_login {
      ...
      function qw_social_print_code($tourl, $logout, $context) {
            ...
            ?>
            <a class="open-login-button context-<?php echo $classes ?> icon-social-<?php echo $css; ?>" title="<?php echo $title; ?>" href="<?php echo $url ?>" rel="nofollow"><span><?php echo $text ?></span></a>
            <?php
      }
